...
public class GUI_IPOd {
  ...
  */
	 ...
	 * desempenara en el GUI.
	 * 	@author Carlos Calderon, 15219
   	 *	@author Jorge Azmitia,15202
   	 *	@version 2.4.0 Julio 15, 2016
	 */
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (e.getSource() == btnFav1) {
					if (guardar==true){
						...
						if (ipod.selectEmisora(0)<400 && ipod.selectEmisora(0)>0){
							combo.setSelectedItem("F.M.");
							emisoraa=ipod.selectEmisora(0);
							lblnumest.setText(""+ipod.selectEmisora(0));
						}
						else if(ipod.selectEmisora(0)<=0){
							JOptionPane.showMessageDialog(null, "No hay emisora guardada en este boton", "Error", JOptionPane.ERROR_MESSAGE);
						}
						else	if (ipod.selectEmisora(0)>400){
			...
			if (e.getSource() == btnFav2) {
				if (guardar==true){
					...
					if (ipod.selectEmisora(1)<400 && ipod.selectEmisora(1)>0){
						combo.setSelectedItem("F.M.");
						emisoraa=ipod.selectEmisora(1);
						lblnumest.setText(""+ipod.selectEmisora(1));
					}
					else if(ipod.selectEmisora(1)<=0){
						JOptionPane.showMessageDialog(null, "No hay emisora guardada en este boton", "Error", JOptionPane.ERROR_MESSAGE);
					}
					else if (ipod.selectEmisora(1)>400){
						combo.setSelectedItem("A.M.");
						emisorab=ipod.selectEmisora(1);
						lblnumest.setText(""+ipod.selectEmisora(1));		
						}
				}
			}
			if (e.getSource() == btnFav3) {
				if (guardar==true){
					...
					if (ipod.selectEmisora(2)<400 && ipod.selectEmisora(2)>0){
						combo.setSelectedItem("F.M.");
						emisoraa=ipod.selectEmisora(2);
						lblnumest.setText(""+ipod.selectEmisora(2));
					}
					else if(ipod.selectEmisora(2)<=0){
						JOptionPane.showMessageDialog(null, "No hay emisora guardada en este boton", "Error", JOptionPane.ERROR_MESSAGE);
					}
					else if (ipod.selectEmisora(2)>400){
						combo.setSelectedItem("A.M.");
						emisorab=ipod.selectEmisora(0);
						lblnumest.setText(""+ipod.selectEmisora(2));		
						}
			...
			if (e.getSource() == btnFav4) {
				if (guardar==true){
					...
					if (ipod.selectEmisora(3)<400 && ipod.selectEmisora(3)>0){
						combo.setSelectedItem("F.M.");
						emisoraa=ipod.selectEmisora(3);
						lblnumest.setText(""+ipod.selectEmisora(3));
					}
					else if(ipod.selectEmisora(3)<=0){
						JOptionPane.showMessageDialog(null, "No hay emisora guardada en este boton", "Error", JOptionPane.ERROR_MESSAGE);
					}
					else if (ipod.selectEmisora(3)>400){
						combo.setSelectedItem("A.M.");
						emisorab=ipod.selectEmisora(3);
						lblnumest.setText(""+ipod.selectEmisora(3));		
						}
					}
			}
			if (e.getSource() == btnFav5) {
				if (guardar==true){
					...
					if (ipod.selectEmisora(4)<400 && ipod.selectEmisora(4)>0){
						combo.setSelectedItem("F.M.");
						emisoraa=ipod.selectEmisora(4);
						lblnumest.setText(""+ipod.selectEmisora(4));
					}
					else if(ipod.selectEmisora(4)<=0){
						JOptionPane.showMessageDialog(null, "No hay emisora guardada en este boton", "Error", JOptionPane.ERROR_MESSAGE);
					}
					if (ipod.selectEmisora(4)>400){
						combo.setSelectedItem("A.M.");
						emisorab=ipod.selectEmisora(4);
						lblnumest.setText(""+ipod.selectEmisora(4));		
						}				
					}
			}
			if (e.getSource() == btnFav6) {
				if (guardar==true){
					...
					if (ipod.selectEmisora(5)<400 && ipod.selectEmisora(5)>0){
						combo.setSelectedItem("F.M.");
						emisoraa=ipod.selectEmisora(5);
						lblnumest.setText(""+ipod.selectEmisora(5));			
					}
					else if(ipod.selectEmisora(5)<=0){
						JOptionPane.showMessageDialog(null, "No hay emisora guardada en este boton", "Error", JOptionPane.ERROR_MESSAGE);
					}
					else if (ipod.selectEmisora(5)>400){
						combo.setSelectedItem("A.M.");
						emisorab=ipod.selectEmisora(5);
						lblnumest.setText(""+ipod.selectEmisora(5));		
						}				
					}
			}
			if (e.getSource() == btnFav7) {
				if (guardar==true){
					...
					if (ipod.selectEmisora(6)<400 && ipod.selectEmisora(6)>0){
						combo.setSelectedItem("F.M.");
						emisoraa=ipod.selectEmisora(6);
						lblnumest.setText(""+ipod.selectEmisora(6));
					}
					else if(ipod.selectEmisora(6)<=0){
						JOptionPane.showMessageDialog(null, "No hay emisora guardada en este boton", "Error", JOptionPane.ERROR_MESSAGE);
					}
					else if (ipod.selectEmisora(6)>400){
						combo.setSelectedItem("A.M.");
						emisorab=ipod.selectEmisora(6);
						lblnumest.setText(""+ipod.selectEmisora(6));		
						}
				}
			}
			if (e.getSource() == btnFav8) {
				if (guardar==true){
					...
					if (ipod.selectEmisora(7)<400 && ipod.selectEmisora(7)>0){
						combo.setSelectedItem("F.M.");
						emisoraa=ipod.selectEmisora(7);
						lblnumest.setText(""+ipod.selectEmisora(7));
					}
					else if(ipod.selectEmisora(7)<=0){
						JOptionPane.showMessageDialog(null, "No hay emisora guardada en este boton", "Error", JOptionPane.ERROR_MESSAGE);
					}
					else if (ipod.selectEmisora(7)>400){
						combo.setSelectedItem("A.M.");
						emisorab=ipod.selectEmisora(7);
						lblnumest.setText(""+ipod.selectEmisora(7));		
						}					
				}
			}
			if (e.getSource() == btnFav9) {
				if (guardar==true){
					...
					if (ipod.selectEmisora(8)<400 && ipod.selectEmisora(8)>0){
						combo.setSelectedItem("F.M.");
						emisoraa=ipod.selectEmisora(8);
						lblnumest.setText(""+ipod.selectEmisora(8));
					}
					else if(ipod.selectEmisora(8)<=0){
						JOptionPane.showMessageDialog(null, "No hay emisora guardada en este boton", "Error", JOptionPane.ERROR_MESSAGE);
					}
					else if (ipod.selectEmisora(8)>400){
						combo.setSelectedItem("A.M.");
						emisorab=ipod.selectEmisora(8);
						lblnumest.setText(""+ipod.selectEmisora(8));		
						}
				}
			}
			if (e.getSource() == btnFav10) {
				if (guardar==true){
					...
					if (ipod.selectEmisora(9)<400 && ipod.selectEmisora(9)>0){
						combo.setSelectedItem("F.M.");
						emisoraa=ipod.selectEmisora(9);
						lblnumest.setText(""+ipod.selectEmisora(9));
					}
					else if(ipod.selectEmisora(9)<=0){
						JOptionPane.showMessageDialog(null, "No hay emisora guardada en este boton", "Error", JOptionPane.ERROR_MESSAGE);
					}
					else if (ipod.selectEmisora(9)>400){
						combo.setSelectedItem("A.M.");
						emisorab=ipod.selectEmisora(9);
						lblnumest.setText(""+ipod.selectEmisora(9));		
						}
				}
			}
			if (e.getSource() == btnFav11) {
				if (guardar==true){
					...
					if (ipod.selectEmisora(10)<400 && ipod.selectEmisora(10)>0){
						combo.setSelectedItem("F.M.");
						emisoraa=ipod.selectEmisora(10);
						lblnumest.setText(""+ipod.selectEmisora(10));
					}
					else if(ipod.selectEmisora(10)<=0){
						JOptionPane.showMessageDialog(null, "No hay emisora guardada en este boton", "Error", JOptionPane.ERROR_MESSAGE);
					}
					else if (ipod.selectEmisora(10)>400){
						combo.setSelectedItem("A.M.");
						emisorab=ipod.selectEmisora(10);
						lblnumest.setText(""+ipod.selectEmisora(10));		
						}
				}
			}
			if (e.getSource() == btnFav12) {
				if (guardar==true){
					...
					if (ipod.selectEmisora(11)<400 && ipod.selectEmisora(11)>0){
						combo.setSelectedItem("F.M.");
						emisoraa=ipod.selectEmisora(11);
						lblnumest.setText(""+ipod.selectEmisora(11));
					}
					else if(ipod.selectEmisora(11)<=0){
						JOptionPane.showMessageDialog(null, "No hay emisora guardada en este boton", "Error", JOptionPane.ERROR_MESSAGE);
					}
					else if (ipod.selectEmisora(11)>400){
						combo.setSelectedItem("A.M.");
						emisorab=ipod.selectEmisora(11);
						lblnumest.setText(""+ipod.selectEmisora(11));		
						}
				}
			}
